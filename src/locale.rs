...
//!
//! Язык определяется по LANG/LC_ALL. Если начинается с "ru" — русский,
//! иначе английский.
...
const EN: Strings = Strings {
    ...
    help_add: "add + sync overlay (or just sync if already installed)",
...
/// Инициализировать локаль. Вызвать при старте.
pub fn init() {
...
/// Получить текущую локаль. Паникует если init() не был вызван.
